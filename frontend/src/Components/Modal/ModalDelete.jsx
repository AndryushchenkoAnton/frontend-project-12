                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="d-flex justify-content-end">
                                <button type="button" className="me-2 btn btn-secondary" onClick={closeHandler}>Отменить</button>
                                <button type="button" className="btn btn-danger" onClick={deleteHandler(id)}>Удалить</button>
                            </div>
                        </div>
                    </div>
                </div>
